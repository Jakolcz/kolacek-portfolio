...
export const translations = {
    ...
    cs: {
        ...
        'about.journey.p3': 'Před <strong class="text-slate-900 dark:text-white font-semibold">půl rokem</strong> jsem se postavil na vlastní nohy. Svým klientům nyní nabízím enterprise kvalitu a stabilitu napřímo. Sázím na ověřené technologie—<strong class="text-emerald-700 dark:text-primary font-mono">Java</strong>, <strong class="text-emerald-700 dark:text-primary font-mono">Spring</strong> a <strong class="text-emerald-700 dark:text-primary font-mono">SQL</strong> jsou mé hlavní nástroje, protože jednoduše fungují a dobře se škálují.',
